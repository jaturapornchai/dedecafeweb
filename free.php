        ...
        <div class="card custom-card">
            <div class="card-body">
                ...
                <div class="custom-list">
                    ...
                    <div class="custom-list-item">
                        <i class="bi bi-display-fill me-2 text-warning"></i>
        ...
        <div class="card custom-card">
            <div class="card-body">
                ...
                <div class="custom-list">
                    ...
                    <div class="custom-list-item">
                        <i class="bi bi-person-check-fill me-2 text-success"></i>
                        <b>ระบบ KIOSK สามารถใช้แบบผสมได้</b> ทั้งให้ลูกค้าสั่งเองที่เครื่อง สั่งด้วยมือถือของลูกค้าเอง หรือสั่งผ่านเจ้าของร้าน หรือพนักงาน เงื่อนไขเดียวคือ ต้องชำระเงินก่อน
                    </div>
                    <div class="custom-list-item">
                        <i class="bi bi-person-check-fill me-2 text-success"></i>
        ...
        <div class="card custom-card">
            <div class="card-body">
                ...
                <div class="custom-list">
                    ...
                    <div class="custom-list-item">
                        <i class="bi bi-arrow-right-circle-fill me-2 text-danger"></i>
                    ...
                    <div class="custom-list-item">
                        <i class="bi bi-display-fill me-2 text-info"></i>
        ...
        <div class="card custom-card mb-4">
            <div class="card-body">
                ...
                <div class="custom-list">
                    ...
                    <div class="custom-list-item">
                        <i class="bi bi-credit-card-fill me-2 text-warning"></i>
